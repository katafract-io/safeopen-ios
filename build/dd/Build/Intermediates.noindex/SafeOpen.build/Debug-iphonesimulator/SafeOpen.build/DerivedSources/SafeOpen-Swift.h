...
#ifndef SAFEOPEN_SWIFT_H
#define SAFEOPEN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SafeOpen",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SafeOpen20CameraScannerService")
@interface CameraScannerService : NSObject
...
@interface CameraScannerService (SWIFT_EXTENSION(SafeOpen)) <AVCaptureMetadataOutputObjectsDelegate>
